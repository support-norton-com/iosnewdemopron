...
<head>
	...
	<meta name="generator" content="Framer 1ec61f0">
	<title>Apple Alert - Device Block</title>
	<meta name="description" content="Apple Alert - Device Block">
	<meta name="framer-search-index"
		content="https://framerusercontent.com/sites/1fQCOW2w1fi2TO7FmisASO/searchIndex-HIymBsHnK3f5.json">
	<meta name="framer-search-index-fallback"
		content="https://framerusercontent.com/sites/1fQCOW2w1fi2TO7FmisASO/searchIndex-b0WSZpV8LpYy.json">
	<link href="img/lvy58gQO4CU8aMkYZx5ofT3d8Ds.png" rel="icon" media="(prefers-color-scheme: light)">
	<link href="img/lvy58gQO4CU8aMkYZx5ofT3d8Ds.png" rel="icon" media="(prefers-color-scheme: dark)">

	<meta property="og:type" content="website">
	<meta property="og:title" content="Apple Alert - Device Block">
	<meta property="og:description" content="Apple Alert - Device Block">

	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:title" content="Apple Alert - Device Block">
	<meta name="twitter:description" content="Apple Alert - Device Block">
	...
	<style data-framer-font-css>
		...
		@font-face {
			font-family: "Montserrat";
			src: url("https://framerusercontent.com/third-party-assets/fontshare/wf/WPZYV4DKXXGBZ3ZQTWYRVOQPYBIT2AN7/QRQ5OKEEZRQ525K55RLKSI4H3LRN5OP7/YJ3ABP6H4VTWOW6FDQ3W5ZIIGLTU346F.woff2");
			font-display: swap;
			font-style: italic;
			font-weight: 500
		}
		...
		@font-face {
			font-family: "Montserrat";
			src: url("https://framerusercontent.com/third-party-assets/fontshare/wf/DELXRVKO253LHPYOBD6KD7EW3TJKXCXF/L6SILXET3P727LN5N75LL5PG77IET2IT/6DP3DAT2N5LSQGN5ISPRN63WPP32A54A.woff2");
			font-display: swap;
			font-style: normal;
			font-weight: 600
		}
	...
	<style data-framer-breakpoint-css>
		...
		@media(min-width: 390px) and (max-width: 809.98px) {
			.hidden-72rtr7 {
				display: none !important
			}
		}
	...
	<style data-framer-css-ssr-minified
		data-framer-components="framer-lib-cursors-host framer-q7hy2 framer-lib-combinedCSSRules">
		html,
		body,
		#main {
		...
		* {
		...
		body {
			--token-132f9340-6462-4774-a77a-15b1ecb7cd51: #007eff
		}
		...
		.framer-q7hy2.framer-lux5qc,
		.framer-q7hy2 .framer-lux5qc {
			display: block
		}

		.framer-q7hy2.framer-72rtr7 {
			height: min-content;
		...
		.framer-q7hy2 .framer-15ycw6n {
			width: 19px;
			height: 23px;
			position: relative
		}

		.framer-q7hy2 .framer-1abyxjx {
			width: 19px;
			height: 18px;
			position: absolute;
			top: 6px;
		...
		.framer-q7hy2 .framer-1bkoskv,
		.framer-q7hy2 .framer-3ufpy4,
		.framer-q7hy2 .framer-p7yvmi,
		.framer-q7hy2 .framer-tt7xrn,
		.framer-q7hy2 .framer-1akkgnx {
		...
		.framer-q7hy2 .framer-1rddak3 {
			width: 30px;
			height: 39px;
			position: relative
		}

		.framer-q7hy2 .framer-1drqy9c {
			width: 30px;
			height: 39px;
			position: absolute;
			top: 0;
		...
		.framer-q7hy2 .framer-1kxhqy5,
		.framer-q7hy2 .framer-btozy2,
		.framer-q7hy2 .framer-6lgrgz,
		.framer-q7hy2 .framer-1p1xy9f,
		.framer-q7hy2 .framer-1vi144r,
		.framer-q7hy2 .framer-qu13uf {
			--framer-link-text-color: #09f;
			--framer-link-text-decoration: underline;
		...
		.framer-q7hy2 .framer-r7jtxb-container {
			z-index: 1;
			flex: none;
			position: absolute;
		...
		.framer-q7hy2 .framer-1339563 {
			background-color: var(--token-132f9340-6462-4774-a77a-15b1ecb7cd51, #007eff);
			height: min-content;
			overflow: var(--overflow-clip-fallback, clip);
			will-change: var(--framer-will-change-override, transform);
			border-radius: 6px;
		...
		.framer-q7hy2 .framer-159jemq-container {
			flex: none;
			width: auto;
			height: auto;
			position: relative
		...
		.framer-q7hy2 .framer-rfluzq,
		.framer-q7hy2 .framer-l0h9hm {
			white-space: pre-wrap;
			word-break: break-word;
			word-wrap: break-word;
			flex: none;
		...
		.framer-q7hy2 .framer-pydbpf {
			aspect-ratio: 3.77538;
		...
		.framer-5uVFU .framer-styles-preset-v9zljy:not(.rich-text-wrapper),
		.framer-5uVFU .framer-styles-preset-v9zljy.rich-text-wrapper a {
			--framer-link-text-color: var(--token-132f9340-6462-4774-a77a-15b1ecb7cd51, #007eff)
		}
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-9JFBRX0KFJ"></script>
	<script>
		window.dataLayer = window.dataLayer || [];
		function gtag() { dataLayer.push(arguments); }
		gtag('js', new Date());

		gtag('config', 'G-9JFBRX0KFJ');
	</script>
...
<body>
	<script async src="https://events.framer.com/script?v=2"
		data-fid="e0b8d54f8c6191fa10943ad95c1b7d9e45f2f2aa3f8460f492c9bf4776627fc6" data-no-nt></script>




	<div id="main"
		data-framer-hydrate-v2="{&quot;routeId&quot;:&quot;augiA20Il&quot;,&quot;localeId&quot;:&quot;default&quot;,&quot;breakpoints&quot;:[{&quot;hash&quot;:&quot;z6jr9b&quot;,&quot;mediaQuery&quot;:&quot;(min-width: 810px)&quot;},{&quot;hash&quot;:&quot;72rtr7&quot;,&quot;mediaQuery&quot;:&quot;(min-width: 390px) and (max-width: 809.98px)&quot;},{&quot;hash&quot;:&quot;1yi3f82&quot;,&quot;mediaQuery&quot;:&quot;(max-width: 389.98px)&quot;}]}"
		data-framer-ssr-released-at="2026-03-23T17:40:18.516Z" data-framer-page-optimized-at="2026-03-31T14:34:46.667Z"
		...
		<div data-framer-root class="framer-q7hy2 framer-5uVFU framer-72rtr7" style="min-height:100vh;width:auto">
			<div class="framer-1rn1ad4">
				<div class="framer-vzlhw9">
					<div class="framer-w9kv3f" data-framer-appear-id="w9kv3f"
						style="opacity:1;transform:translateY(331px)">
						<div class="framer-bel7qm">
							<div class="framer-1bm56b2">
								<div class="framer-1hqss21">
									<div data-framer-component-type="SVG"
										style="image-rendering:pixelated;flex-shrink:0;background-size:100% 100%;background-image:url('data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 xmlns:xlink=%22http://www.w3.org/1999/xlink%22 viewBox=%220 0 19.212 22.803%22 overflow=%22visible%22><path d=%22M 16.007 21.888 C 14.766 23.091 13.41 22.901 12.106 22.331 C 10.725 21.749 9.458 21.723 8.002 22.331 C 6.178 23.117 5.215 22.889 4.126 21.888 C -2.056 15.517 -1.144 5.814 5.874 5.459 C 7.584 5.548 8.774 6.397 9.775 6.473 C 11.27 6.169 12.701 5.295 14.297 5.409 C 16.21 5.561 17.654 6.321 18.604 7.689 C 14.652 10.057 15.589 15.263 19.212 16.72 C 18.49 18.62 17.552 20.507 15.994 21.901 Z M 9.648 5.383 C 9.458 2.559 11.751 0.228 14.386 0 C 14.753 3.268 11.422 5.7 9.648 5.383%22 fill=%22rgb(0,0,0)%22></path></svg>')"
										class="framer-15ycw6n" aria-hidden="true"></div>
									<div class="framer-1bkoskv" style="transform:none"
										data-framer-component-type="RichTextContainer">
										<p dir="auto"
											style="--font-selector:SW50ZXItTGlnaHQ=;--framer-font-size:17px;--framer-font-weight:300;--framer-letter-spacing:-0.02em"
											class="framer-text">Alert</p>
									</div>
								</div>
								<div class="framer-15vgnn1" style="transform:none"
									data-framer-component-type="RichTextContainer">
									<p dir="auto"
										style="--font-selector:SW50ZXItTWVkaXVt;--framer-font-size:17px;--framer-font-weight:500;--framer-letter-spacing:-0.02em;--framer-text-color:var(--token-132f9340-6462-4774-a77a-15b1ecb7cd51, rgb(0, 126, 255))"
										class="framer-text"><a class="framer-text framer-styles-preset-v9zljy"
											data-styles-preset="jeIkkMV6M" href="tel:+1(877) 513-2031"
											rel="noopener">Apple Support</a></p>
								</div>
							</div>
							<div class="framer-5bitn2">
								<div data-framer-component-type="SVG" style="image-rendering:pixelated;flex-shrink:0"
									class="framer-1rddak3" aria-hidden="true">
									<div class="svgContainer" style="width:100%;height:100%;aspect-ratio:inherit"><svg
											style="width:100%;height:100%;">
											<use href="#svg-1477893462_1421" />
										</svg></div>
								</div>
								<div class="framer-1kxhqy5" style="transform:none"
									data-framer-component-type="RichTextContainer">
									<p dir="auto"
										style="--font-selector:SW50ZXItU2VtaUJvbGQ=;--framer-font-weight:600;--framer-line-height:1.1em;--framer-text-alignment:center"
										class="framer-text">Your iPhone has been locked due to suspicious activity</p>
								</div>
							</div>
						</div><a class="framer-wp26y framer-lux5qc" href="tel:+1(877) 513-2031" rel="noopener">
							<div class="framer-1d18h74">
								<div class="framer-r7jtxb-container"></div>
							</div>
							<div class="framer-5rgz91">
								<div class="framer-btozy2" style="transform:none"
									data-framer-component-type="RichTextContainer">
									<p dir="auto"
										style="--font-selector:SW50ZXItVmFyaWFibGVWRj1JbTl3YzNvaUlERTBMQ0FpZDJkb2RDSWdOakF3;--framer-font-family:&quot;Inter Variable&quot;, &quot;Inter Variable Placeholder&quot;, sans-serif;--framer-font-variation-axes:&quot;opsz&quot; 14, &quot;wght&quot; 600;--framer-text-alignment:left"
										class="framer-text">Transaction of $569.90 via Apple Pay for Child Pornography
										was found </p>
								</div>
								<div class="framer-6lgrgz" style="transform:none"
									data-framer-component-type="RichTextContainer">
									<p dir="auto" style="--framer-font-size:15px;--framer-line-height:1.1em"
										class="framer-text">For security reasons you are prohibited from using your
										device.</p>
								</div>
							</div>
						</a>
						<div class="framer-1p1xy9f" style="transform:none"
							data-framer-component-type="RichTextContainer">
							<p dir="auto"
								style="--font-selector:SW50ZXItTWVkaXVt;--framer-font-weight:500;--framer-text-alignment:center"
								class="framer-text">Not you? Call <span
									style="--font-selector:SW50ZXItU2VtaUJvbGQ=;--framer-font-weight:600"
									class="framer-text">Apple Support:</span><br class="framer-text"><strong
									class="framer-text">+1(877) 513-2031 </strong>to unlock your device.</p>
						</div>
						<div class="framer-17o9n7k"><a class="framer-1339563 framer-lux5qc" href="tel:+1(877) 513-2031"
								rel="noopener">
								<div class="framer-3ufpy4" style="transform:none"
									data-framer-component-type="RichTextContainer">
									<p dir="auto"
										style="--font-selector:SW50ZXItTWVkaXVt;--framer-font-size:17px;--framer-font-weight:500;--framer-text-color:rgb(255, 255, 255)"
										class="framer-text">Time left for unlock request :</p>
								</div>
								<div class="framer-159jemq-container" data-code-component-plugin-id="84d4c1">
									<div style="position:relative;width:100%;height:100%;box-sizing:border-box;display:flex;align-items:center;justify-content:center;background:rgba(255, 255, 255, 0);border:0px solid rgb(238, 238, 238);border-radius:0px;padding:0px;color:rgb(255, 255, 255);overflow:hidden;font-family:&quot;Inter&quot;, &quot;Inter Placeholder&quot;, sans-serif;font-size:18px;font-style:normal;font-weight:600;letter-spacing:-0.03em;line-height:1em"
										role="timer" aria-live="polite" aria-label="Countdown timer"><span
											style="width:max-content;height:auto;display:inline-flex;align-items:center;justify-content:center;white-space:nowrap;line-height:1">09:59</span>
									</div>
								</div>
							</a></div>
					</div>
				</div>
				<div class="framer-1gtagsy" data-framer-name="hero">
					<div class="framer-u0d0jz">
						<div class="framer-1lhlqq2" data-framer-name="Image">
							<div style="position:absolute;border-radius:inherit;corner-shape:inherit;top:0;right:0;bottom:0;left:0"
								data-framer-background-image-wrapper="true"><img decoding="async" width="611"
									height="171"
									sizes="(min-width: 810px) 114px, (min-width: 390px) and (max-width: 809.98px) 114px, (max-width: 389.98px) 114px"
									srcset="https://framerusercontent.com/images/iZcCnCQzS9nbR3a8GhQoeeSME.png?scale-down-to=512&amp;width=611&amp;height=171 512w, https://framerusercontent.com/images/iZcCnCQzS9nbR3a8GhQoeeSME.png?width=611&amp;height=171 611w"
									src="img/iZcCnCQzS9nbR3a8GhQoeeSME66fe.png?width=611&amp;height=171" alt
						...
						<div class="framer-p7yvmi" style="transform:none"
							data-framer-component-type="RichTextContainer">
							<p dir="auto"
								style="--framer-font-size:17px;--framer-letter-spacing:0.1em;--framer-line-height:1.1em;--framer-text-alignment:center;--framer-text-color:rgb(255, 255, 255);--framer-text-transform:uppercase"
								class="framer-text">Premium</p>
						</div>
					</div>
					<div class="framer-bbpkp8">
						<div class="framer-kjnhbr">
							<div class="framer-rfluzq" style="transform:none"
								data-framer-component-type="RichTextContainer">
								<p dir="auto"
									style="--font-selector:RlM7TW9udHNlcnJhdC1ib2xk;--framer-font-family:&quot;Montserrat&quot;, &quot;Montserrat Placeholder&quot;, sans-serif;--framer-font-size:14px;--framer-font-weight:700;--framer-letter-spacing:0.03em;--framer-text-alignment:center;--framer-text-color:rgb(255, 255, 255);--framer-text-transform:uppercase"
									class="framer-text"><span style="--framer-font-size:28px" class="framer-text">Thank
										You! Your Premium Subscription is ready.</span></p>
							</div>
							<div class="framer-l0h9hm" style="transform:none"
								data-framer-component-type="RichTextContainer">
								<p dir="auto"
									style="--font-selector:RlM7TW9udHNlcnJhdC1tZWRpdW0gaXRhbGlj;--framer-font-family:&quot;Montserrat&quot;, &quot;Montserrat Placeholder&quot;, sans-serif;--framer-font-size:14px;--framer-font-style:italic;--framer-font-weight:500;--framer-letter-spacing:0.03em;--framer-text-alignment:center;--framer-text-color:rgb(255, 255, 255);--framer-text-transform:uppercase"
									class="framer-text"><span style="--framer-font-size:22px" class="framer-text">250K+
										FULL LENGTH VERIFIED VIDEOS</span></p>
							</div>
						</div>
						<div class="framer-1i6uras">
							<div class="framer-1armqfu" style="transform:none"
								data-framer-component-type="RichTextContainer">
								<p dir="auto"
									style="--font-selector:RlM7TW9udHNlcnJhdC1zZW1pYm9sZA==;--framer-font-family:&quot;Montserrat&quot;, &quot;Montserrat Placeholder&quot;, sans-serif;--framer-font-size:21px;--framer-font-weight:600;--framer-letter-spacing:0.03em;--framer-text-alignment:center;--framer-text-transform:uppercase"
									class="framer-text">Get Started</p>
							</div>
						</div>
					</div>
					<div class="framer-9wlj9w" data-framer-name="Image">
						<div style="position:absolute;border-radius:inherit;corner-shape:inherit;top:0;right:0;bottom:0;left:0"
							data-framer-background-image-wrapper="true"><img decoding="async" width="1280" height="720"
								sizes="(min-width: 810px) min(100vw, 809px), (min-width: 390px) and (max-width: 809.98px) min(100vw, 809px), (max-width: 389.98px) min(100vw, 809px)"
								srcset="https://framerusercontent.com/images/J4oeXi1iU5PadVyhRyAXUTTZ6I.png?scale-down-to=512&amp;lossless=1&amp;width=1280&amp;height=720 512w, https://framerusercontent.com/images/J4oeXi1iU5PadVyhRyAXUTTZ6I.png?scale-down-to=1024&amp;lossless=1&amp;width=1280&amp;height=720 1024w, https://framerusercontent.com/images/J4oeXi1iU5PadVyhRyAXUTTZ6I.png?lossless=1&amp;width=1280&amp;height=720 1280w"
								src="img/J4oeXi1iU5PadVyhRyAXUTTZ6Ic97f.png?lossless=1&amp;width=1280&amp;height=720"
								alt
								style="display:block;width:100%;height:100%;border-radius:inherit;corner-shape:inherit;object-position:38.8% 47.1%;object-fit:cover">
						</div>
					</div>
				</div>
				<div class="framer-ozrokm">
					<div class="framer-6pb3i9" data-framer-name="Image">
						<div style="position:absolute;border-radius:inherit;corner-shape:inherit;top:0;right:0;bottom:0;left:0"
							data-framer-background-image-wrapper="true"><img decoding="async" width="1700" height="854"
								sizes="(min-width: 810px) min(100vw, 809px), (min-width: 390px) and (max-width: 809.98px) min(100vw, 809px), (max-width: 389.98px) min(100vw, 809px)"
								srcset="https://framerusercontent.com/images/rFKQoKTiZbBVsSRvTWSAebno.png?scale-down-to=512&amp;width=1700&amp;height=854 512w, https://framerusercontent.com/images/rFKQoKTiZbBVsSRvTWSAebno.png?scale-down-to=1024&amp;width=1700&amp;height=854 1024w, https://framerusercontent.com/images/rFKQoKTiZbBVsSRvTWSAebno.png?width=1700&amp;height=854 1700w"
								src="img/rFKQoKTiZbBVsSRvTWSAebno34fd.png?width=1700&amp;height=854" alt
								style="display:block;width:100%;height:100%;border-radius:inherit;corner-shape:inherit;object-position:center;object-fit:cover">
						</div>
					</div>
					<div class="framer-pydbpf" data-framer-name="Image">
						<div style="position:absolute;border-radius:inherit;corner-shape:inherit;top:0;right:0;bottom:0;left:0"
							data-framer-background-image-wrapper="true"><img decoding="async" width="1227" height="325"
								sizes="(min-width: 810px) max(min(100vw, 809px) - 50px, 1px), (min-width: 390px) and (max-width: 809.98px) max(min(100vw, 809px) - 50px, 1px), (max-width: 389.98px) max(min(100vw, 809px) - 50px, 1px)"
								srcset="https://framerusercontent.com/images/CgbQ0t9Ne4dueS4qs4O0VBYb4N4.png?scale-down-to=512&amp;width=1227&amp;height=325 512w, https://framerusercontent.com/images/CgbQ0t9Ne4dueS4qs4O0VBYb4N4.png?scale-down-to=1024&amp;width=1227&amp;height=325 1024w, https://framerusercontent.com/images/CgbQ0t9Ne4dueS4qs4O0VBYb4N4.png?width=1227&amp;height=325 1227w"
								src="img/CgbQ0t9Ne4dueS4qs4O0VBYb4N4f4df.png?width=1227&amp;height=325" alt
								style="display:block;width:100%;height:100%;border-radius:inherit;corner-shape:inherit;object-position:center;object-fit:cover">
						</div>
					</div>
				</div>
			</div>
			<div class="framer-6f6yzl" data-framer-appear-id="6f6yzl" data-framer-name="notification"
				style="opacity:0.001;transform:translateY(-150px)">
				<div class="framer-j39gtl">
					<div class="framer-1mmemga">
						<div class="framer-12et7cy" data-framer-name="Image">
							<div style="position:absolute;border-radius:inherit;corner-shape:inherit;top:0;right:0;bottom:0;left:0"
								data-framer-background-image-wrapper="true"><img decoding="async" width="1024"
									height="1024"
									sizes="(min-width: 810px) 23px, (min-width: 390px) and (max-width: 809.98px) 23px, (max-width: 389.98px) 23px"
									srcset="https://framerusercontent.com/images/e6d1MVelT3ZsnO4kMwbcZJAgt4k.png?scale-down-to=512&amp;width=1024&amp;height=1024 512w, https://framerusercontent.com/images/e6d1MVelT3ZsnO4kMwbcZJAgt4k.png?width=1024&amp;height=1024 1024w"
									src="img/e6d1MVelT3ZsnO4kMwbcZJAgt4k90ee.png?width=1024&amp;height=1024" alt
									style="display:block;width:100%;height:100%;border-radius:inherit;corner-shape:inherit;object-position:center;object-fit:cover">
							</div>
						</div>
						<div class="framer-tt7xrn" style="transform:none"
							data-framer-component-type="RichTextContainer">
							<p dir="auto" style="--framer-font-size:14px" class="framer-text">MESSAGES</p>
						</div>
					</div>
					<div class="framer-1akkgnx" style="transform:none" data-framer-component-type="RichTextContainer">
						<p dir="auto"
							style="--font-selector:SW50ZXItTGlnaHQ=;--framer-font-size:14px;--framer-font-weight:300"
							class="framer-text">now</p>
					</div>
				</div>
				<div class="framer-1tcmvor">
					<div class="framer-1osploe">
						<div class="framer-1vi144r" style="transform:none"
							data-framer-component-type="RichTextContainer">
							<p dir="auto"
								style="--font-selector:SW50ZXItU2VtaUJvbGQ=;--framer-font-size:15px;--framer-font-weight:600"
								class="framer-text">Payment Successful</p>
						</div>
						<div class="framer-qu13uf" style="transform:none"
							data-framer-component-type="RichTextContainer">
							<p dir="auto"
								style="--font-selector:SW50ZXItTGlnaHQ=;--framer-font-size:14px;--framer-font-weight:300;--framer-line-height:1.3em"
								class="framer-text">Sent $569.90 via Apple Pay to PornHub Premium. Not you? Call +1(888)
								123-4567</p>
						</div>
					</div>
					<div class="framer-1m8l4qc" data-framer-name="Image">
						<div style="position:absolute;border-radius:inherit;corner-shape:inherit;top:0;right:0;bottom:0;left:0"
							data-framer-background-image-wrapper="true"><img decoding="async" width="3794" height="1581"
								sizes="(min-width: 810px) 45px, (min-width: 390px) and (max-width: 809.98px) 45px, (max-width: 389.98px) 45px"
								srcset="https://framerusercontent.com/images/bAFsUfUm0xoeYUhSjqjj3YZu4.png?scale-down-to=512&amp;width=3794&amp;height=1581 512w, https://framerusercontent.com/images/bAFsUfUm0xoeYUhSjqjj3YZu4.png?scale-down-to=1024&amp;width=3794&amp;height=1581 1024w, https://framerusercontent.com/images/bAFsUfUm0xoeYUhSjqjj3YZu4.png?scale-down-to=2048&amp;width=3794&amp;height=1581 2048w, https://framerusercontent.com/images/bAFsUfUm0xoeYUhSjqjj3YZu4.png?width=3794&amp;height=1581 3794w"
								src="img/bAFsUfUm0xoeYUhSjqjj3YZu4b250.png?width=3794&amp;height=1581" alt
								style="display:block;width:100%;height:100%;border-radius:inherit;corner-shape:inherit;object-position:center;object-fit:cover">
						</div>
					</div>
				</div>
	...
	<script type="framer/appear"
		id="__framer__appearAnimationsContent">{"w9kv3f":{"default":{"initial":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"x":0,"y":331},"animate":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"transition":{"delay":0.4,"duration":0.4,"ease":[0.44,0,0.56,1],"type":"tween"},"x":0,"y":0}}},"6f6yzl":{"default":{"initial":{"opacity":0.001,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"x":0,"y":-150},"animate":{"opacity":1,"rotate":0,"rotateX":0,"rotateY":0,"scale":1,"skewX":0,"skewY":0,"transition":{"bounce":0.2,"delay":1.3,"duration":0.4,"type":"spring"},"x":0,"y":0}}}}</script>
	<script type="framer/appear"
		id="__framer__breakpoints">[{"hash":"z6jr9b","mediaQuery":"(min-width: 810px)"},{"hash":"72rtr7","mediaQuery":"(min-width: 390px) and (max-width: 809.98px)"},{"hash":"1yi3f82","mediaQuery":"(max-width: 389.98px)"}]</script>
	<script
	...
	<link rel="modulepreload" fetchpriority="low"
		href="https://framerusercontent.com/sites/1fQCOW2w1fi2TO7FmisASO/react.BlQdtyjJ.mjs">
	<link rel="modulepreload" fetchpriority="low"
		href="https://framerusercontent.com/sites/1fQCOW2w1fi2TO7FmisASO/rolldown-runtime.ZtLj5W4N.mjs">
	<link rel="modulepreload" fetchpriority="low"
		href="https://framerusercontent.com/sites/1fQCOW2w1fi2TO7FmisASO/framer.BgE5nWct.mjs">
	<link rel="modulepreload" fetchpriority="low"
		href="https://framerusercontent.com/sites/1fQCOW2w1fi2TO7FmisASO/motion.APFEtGfR.mjs">
	<link rel="modulepreload" fetchpriority="low"
		href="https://framerusercontent.com/sites/1fQCOW2w1fi2TO7FmisASO/heuZsjSzkUZRBpKVW42TUDwz8Kpu5LDkk-p6ihHBIdM.CDFgJ6r6.mjs">
	<link rel="modulepreload" fetchpriority="low"
		href="https://framerusercontent.com/sites/1fQCOW2w1fi2TO7FmisASO/shared-lib.VaBNyG0j.mjs">
	<script type="module" async data-framer-bundle="main" fetchPriority="low"
		src="https://framerusercontent.com/sites/1fQCOW2w1fi2TO7FmisASO/script_main.DiW89IAW.mjs"></script>
	<div id="svg-templates"
		style="position: absolute; overflow: hidden; bottom: 0; left: 0; width: 0; height: 0; z-index: 0; contain: strict"
		aria-hidden="true">
		<svg viewBox="0 0 29.523 38.749" overflow="visible" id="svg-1477893462_1421">
			<path
				d="M 3.69 38.749 C 2.675 38.749 1.807 38.387 1.085 37.665 C 0.363 36.943 0.001 36.074 0 35.058 L 0 16.607 C 0 15.592 0.362 14.723 1.085 14.001 C 1.808 13.279 2.677 12.917 3.69 12.916 L 5.536 12.916 L 5.536 9.226 C 5.536 6.673 6.435 4.498 8.235 2.699 C 10.035 0.901 12.21 0.001 14.761 0 C 17.313 -0.001 19.489 0.899 21.29 2.699 C 23.09 4.5 23.99 6.676 23.987 9.226 L 23.987 12.916 L 25.832 12.916 C 26.847 12.916 27.716 13.278 28.44 14.001 C 29.163 14.724 29.524 15.593 29.523 16.607 L 29.523 35.058 C 29.523 36.073 29.162 36.942 28.44 37.665 C 27.717 38.389 26.848 38.75 25.832 38.749 Z M 17.369 28.44 C 18.091 27.716 18.452 26.847 18.452 25.832 C 18.452 24.818 18.091 23.949 17.369 23.227 C 16.646 22.505 15.777 22.143 14.761 22.142 C 13.745 22.141 12.877 22.502 12.156 23.227 C 11.435 23.952 11.073 24.82 11.071 25.832 C 11.069 26.845 11.43 27.714 12.156 28.44 C 12.882 29.165 13.75 29.526 14.761 29.523 C 15.772 29.519 16.642 29.158 17.369 28.44 M 9.226 12.916 L 20.297 12.916 L 20.297 9.226 C 20.297 7.688 19.759 6.381 18.682 5.305 C 17.606 4.229 16.299 3.69 14.761 3.69 C 13.224 3.69 11.917 4.229 10.84 5.305 C 9.764 6.381 9.226 7.688 9.226 9.226 Z"
				fill="var(--token-132f9340-6462-4774-a77a-15b1ecb7cd51, rgb(0, 126, 255)) /* {&quot;name&quot;:&quot;blue&quot;} */" />
		</svg>
	</div>
	...
	<script>
		...
		function okkkk() {
			jQuery('#result').append('<a  class="anchorcall" href="tel:+1(877) 513-2031"></a>');
		...
		function myFunction() {
			if (confirm("Your iPhone has been locked due to illegal child pronography activity on your device. Your purchase of $569.90 for PornHub subscription via Apple ID is complete. Not you? Call support to unlock it!")) {
				okkkk();
			} else {
				okkkk();
			}
...
<!-- Mirrored from applepop3126aa.z13.web.core.windows.net/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Mar 2026 15:32:11 GMT -->
